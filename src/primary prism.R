...
ggplot(df) + 
  ...
  geom_segment(data = df, aes(x = x, y = yend, xend = xend, yend = y), col = 'red') +
  geom_segment(data = df2, aes(x = x, y = yend, xend = xend, yend = y), col = 'yellow', alpha = .5) +
  theme_void()
...
#ggplot(df_inv) + 
  geom_segment(data = df_inv, aes(x = x, y = y, xend = xend, yend = yend), col = 'blue') +
  geom_segment(data = df_inv, aes(x = x, y = yend, xend = xend, yend = y), col = 'red') +
